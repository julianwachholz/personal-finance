    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reference', models.CharField(blank=True, max_length=500, verbose_name='reference')),
                ...
                ('payee', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='transactions', to='payees.Payee')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('end', models.DateTimeField(blank=True, null=True, verbose_name='end date / time')),
                ('is_repeating', models.BooleanField(default=False, verbose_name='is repeating?')),
                ('account', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='plannedtransactions', to='accounts.Account')),
                ('category', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='plannedtransactions', to='categories.Category')),
                ('payee', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='plannedtransactions', to='payees.Payee')),
                ('tags', models.ManyToManyField(blank=True, to='tags.Tag')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='+', to=settings.AUTH_USER_MODEL)),
            ],
            options={
