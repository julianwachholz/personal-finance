    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "interval",
                    models.PositiveIntegerField(default=1, verbose_name="interval"),
                ),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "reference",
                    models.CharField(
                        blank=True, max_length=500, verbose_name="reference"
                    ),
                ),
                (
                    "datetime",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "is_repeating",
                    models.BooleanField(default=False, verbose_name="is repeating?"),
                ),
                (
                    "account",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="plannedtransactions",
                        to="accounts.Account",
                    ),
                ),
                (
